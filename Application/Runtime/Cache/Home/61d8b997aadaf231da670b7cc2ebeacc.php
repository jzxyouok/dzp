...
<link href="/dzp/Public/css/style.css" rel="stylesheet" type="text/css">
    <style>
        html,body{
            width: 100%;
            height: 100%;
        ...
        .box{
            width: 100%;
            height:100%;
            background: url(/dzp/Public/images/dazhuanpan.jpg) center center no-repeat;
...
<script type="text/javascript" src="/dzp/Public/js/jQueryRotate.2.2.js"></script>
		...
		$('#wheelcanvas').rotate({
			...
			callback:function (){
				//alert(txt);跳转到中奖页面的js代码
                                ...
                                if(txt!='谢谢参与'){
                                location='<?php echo U("Home/Dzp/submit/activeid/'+activeid+'/trafficid/'+trafficid+'/grade/'+txt+'");?>';
                            }else{
...
<div class="md-modal md-effect-1" id="modal-1">
    <div class="md-content">
        ...
        <div>
            <p>您本次没有获得奖项!</p>
            <button class="md-close" onclick="close_modal()">关 闭</button>
        </div>
    </div>
</div>
...
<div class="box">
<div class="xingyun">
    <img src="/dzp/Public/images/幸运大转盘1.png" alt="">
</div>
<div class="kePublic">
    <!--效果html开始-->
    <div style="max-width:800px; margin:0 auto">
        <img src="/dzp/Public/images/1.png" id="shan-img" style="display:none;" />
        <img src="/dzp/Public/images/2.png" id="sorry-img" style="display:none;" />
        <div class="banner">
            <div class="turnplate" style="background-image:url(/dzp/Public/images/turnplate-bg.png);background-size:100% 100%;">
                <canvas class="item" id="wheelcanvas" width="422px" height="422px"></canvas>
                <img class="pointer" src="/dzp/Public/images/turnplate-pointer.png"/>
            </div>
        </div>
    </div>
    <div class="jiangxiangshezhi">
        <p style="margin-bottom:3px; font-weight: bold">活动说明：</p>
        <?php echo ($regulation); ?>
    </div>
</div>
</div>
