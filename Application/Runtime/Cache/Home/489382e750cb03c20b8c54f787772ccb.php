...
<link rel="stylesheet" type="text/css" href="/dzp/Public/css/main.css"/>
...
<div id="jieqian" style="<?php if($is_open == 0): ?>display:none;<?php endif; ?>position:absolute;left:150px;top:600px;z-index:105;"><img src="/dzp/Public/images/jieqian.png"></div>
<div id="bg" style="width:640px;height:1008px;background:url(/dzp/Public/images/bag.jpg) no-repeat;">
...
<div id="bg_mohu" style="display:none;z-index:101;width:640px;height:1008px;overflow:hidden;background:url(/dzp/Public/images/bg_mohu.jpg) no-repeat;">
        <div id="feiqian_div" style="display:none;position:absolute;left:210px;top:90px;"><img id="feiqian_img" src="/dzp/Public/images/feiqian/feiqian_1.png" /></div>
        <div id="yaoqian_div" style="position:absolute;left:10px;top:220px;"><img id="yaoqian_img" src="/dzp/Public/images/yaoqian/1.png" /></div>
        ...
        <img src="/dzp/Public/images/daqian.png" /></div>
</div>		
<audio id="audio_bg" src="/dzp/Public/images/5018.mp3">
<audio id="audio_over" src="/dzp/Public/images/4092.mp3">
<div id="bg_mohu" style="z-index:101;width:640px;height:1008px;overflow:hidden;background:url(/dzp/Public/images/bg_mohu.jpg) no-repeat;">
    <div id="daqian_div" <?php if($is_open == 0): ?>onclick="jieqian();"<?php endif; ?> style="position:relative;left:140px;top:90px;"><span style="font-family:隶书;position: absolute;left:140px;color:#8c4f60;top: 335px;font-size:58px;" id="qiantxt_span"></span><span id="shuoming" style="position: absolute;width:60px;left:270px;color:#FFF;top: 425px;font-size:26px;"><div style="float:left;width:30px;">凭桃花签到大悦城</div> <div style="float:left;width:30px;">活动现场参与解签</div></span><img width="346" src="/dzp/Public/images/daqian.png" /></div>		
</div>
<script type="text/javascript">
...
var audio_over = $("#audio_over")[0];
        ...
        function feiqian_fun(){
                ...
                if(feiqian_zhen_temp != feiqian_zhen){
                        $("#feiqian_img").attr('src', '/dzp/Public/images/feiqian/feiqian_' + feiqian_zhen + '.png');
                        //备份签数
...
function yaoqian_fun(){
        ...
        if(yaoqian_zhen_temp != yaoqian_zhen){
                $("#yaoqian_img").attr('src', '/dzp/Public/images/yaoqian/' + yaoqian_zhen + '.png');
                //备份签数
...
<div id="cacheimg" style="position:absolute;left:0px;top:0px;display:none;z-index:-9;">
        <img src="/dzp/Public/images/yaoqian/1.png" />
        <img src="/dzp/Public/images/yaoqian/2.png" />
        <img src="/dzp/Public/images/yaoqian/3.png" />
        <img src="/dzp/Public/images/yaoqian/4.png" />
        <img src="/dzp/Public/images/yaoqian/5.png" />
        <img src="/dzp/Public/images/yaoqian/6.png" />
        <img src="/dzp/Public/images/yaoqian/7.png" />
        <img src="/dzp/Public/images/yaoqian/8.png" />

        <img src="/dzp/Public/images/feiqian/feiqian_1.png" />
        <img src="/dzp/Public/images/feiqian/feiqian_2.png" />
        <img src="/dzp/Public/images/feiqian/feiqian_3.png" />
        <img src="/dzp/Public/images/feiqian/feiqian_4.png" />
        <img src="/dzp/Public/images/feiqian/feiqian_5.png" />
</div>
</body> 
</html>